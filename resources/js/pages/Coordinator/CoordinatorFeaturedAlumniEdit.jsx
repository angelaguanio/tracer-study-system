  ...
  export default function CoordinatorFeaturedAlumniEdit({ featuredAlumni }) {
    ...
    let parsedImages = featuredAlumni?.image;
    ...
    const [formData, setFormData] = useState({
      title: featuredAlumni?.title || "",
      details: featuredAlumni?.details || "",
      image: null,
    });
  ...
  const handleFileChange = (e) => {
    ...
    const handleSubmit = (e) => {
      ...
      router.post(`/coordinator/featured-alumni/${featuredAlumni.id}`, data, {
        forceFormData: true,
        onSuccess: () => {
    ...
    const isRevise = featuredAlumni?.status === "revise";

    return (
      <CoordinatorLayout>
        <>
          <Head title="Edit Featured Alumni" />
                ...
                <CardHeader className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2 w-full sm:w-auto">
                    ...
                    <Button
                      type="button"
                      variant="ghost"
                      onClick={() => router.visit("/coordinator/featured-alumni")}
                      className="p-2"
                    >
                      <ArrowLeft size={18} />
                    </Button>
                    ...
                    <CardTitle className="text-lg font-semibold">
                      {isRevise ? "Resubmit Featured Alumni" : "Edit Featured Alumni"}
                    </CardTitle>
