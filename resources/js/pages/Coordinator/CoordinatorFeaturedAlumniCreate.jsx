...
export default function CoordinatorFeaturedAlumniCreate() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post("/coordinator/featured-alumni", {
            forceFormData: true,
            onSuccess: () => {
                    ...
                    <Card className="w-full flex flex-col h-fit">
                        ...
                        <CardHeader className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            ...
                            <div className="flex items-center gap-2 w-full sm:w-auto">
                                <Link href="/coordinator/featured-alumni">
...
CoordinatorFeaturedAlumniCreate.layout = (page) => (
