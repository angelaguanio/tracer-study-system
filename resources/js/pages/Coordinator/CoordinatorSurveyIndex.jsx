...
import CoordinatorSurveyCard from "@/components/survey/coordinator/CoordinatorSurveyCard";
...
export default function CoordinatorSurveyIndex({ surveys = [] }) {
        ...
        <div className="min-h-screen w-full bg-[#f0faff] p-4 sm:p-6 flex flex-col gap-6">
            ...
            {surveys.length === 0 ? (
                ...
                <div className="flex flex-col gap-3">
                    {surveys.map((survey) => <CoordinatorSurveyCard key={survey.id} survey={survey} />)}
                </div>
            )}
...
CoordinatorSurveyIndex.layout = (page) => <CoordinatorLayout>{page}</CoordinatorLayout>;