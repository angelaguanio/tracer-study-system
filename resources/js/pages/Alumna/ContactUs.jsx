    ...
    <>
      ...
      <div className="bg-blue-50 pb-16">
        <div className="max-w-6xl mx-auto px-6">
          ...
          {/* CARDS */}
          <div className="flex flex-col md:flex-row md:flex-wrap md:justify-center gap-8 mb-12">
            
            {/* EMAIL */}
            <div className="bg-white rounded-xl shadow p-8 w-full md:w-80">
