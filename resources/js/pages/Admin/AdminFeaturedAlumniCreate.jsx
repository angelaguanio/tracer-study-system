...
export default function AdminFeaturedAlumniCreate() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(`/${import.meta.env.VITE_ADMIN_PORTAL_PREFIX}/featured-alumni`, {
            forceFormData: true,
            onSuccess: () => {
                toast.success("Featured Alumni created successfully!");
    ...
    return (
        <>
            <Head title="Create Featured Alumni" />
...
AdminFeaturedAlumniCreate.layout = (page) => (
