...
export default function AdminFeaturedAlumniEdit({ featuredAlumni }) {
  ...
  const handleSubmit = (e) => {
    ...
    router.post(`/${import.meta.env.VITE_ADMIN_PORTAL_PREFIX}/featured-alumni/${featuredAlumni.id}`, data, {
      forceFormData: true,
          ...
          <Card className="w-full flex flex-col min-h-[700px]">
            ...
            <CardHeader className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div className="flex items-center gap-2">
                <Link href={`/${import.meta.env.VITE_ADMIN_PORTAL_PREFIX}/featured-alumni`}>
...
AdminFeaturedAlumniEdit.layout = (page) => (
