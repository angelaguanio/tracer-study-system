...
import AdminFeaturedAlumniCard from "@/components/admin/AdminFeaturedAlumniCard";
...
export default function AdminFeaturedAlumni({ featuredAlumni }) {
  ...
  useEffect(() => {
    const delay = setTimeout(() => {
      router.get(
        `/${import.meta.env.VITE_ADMIN_PORTAL_PREFIX}/featured-alumni`,
  ...
  return (
    <div className="w-full h-full p-2 sm:p-6 flex flex-col gap-4 overflow-y-auto">
      ...
      <div className=" rounded-lg p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Link
          href={`/${import.meta.env.VITE_ADMIN_PORTAL_PREFIX}/featured-alumni/create`}
      ...
      <div className="flex-1 rounded-md">
        <AdminFeaturedAlumniCard featuredAlumni={filteredFeaturedAlumni} />
      </div>
      ...
      <div className="flex justify-start items-center gap-1">
          ...
          <button
            ...
            onClick={() =>
              router.get(
                `/${import.meta.env.VITE_ADMIN_PORTAL_PREFIX}/featured-alumni?page=${featuredAlumni.current_page - 1}`,
                {},
              ...
              return (
                <div key={page} className="flex items-center gap-1">
                  ...
                  <button
                    onClick={() =>
                      router.get(
                        `/${import.meta.env.VITE_ADMIN_PORTAL_PREFIX}/featured-alumni?page=${page}`,
                        {},
                        { preserveState: true, preserveScroll: true }
                      )
                    }
...
AdminFeaturedAlumni.layout = (page) => (
