...
import CoordinatorAnnouncementDeleteConfirmation from "./CoordinatorAnnouncementDeleteConfirmation";
...
export default function CoordinatorAnnouncementDeletePrompt({ children }) {
  ...
  const confirmDelete = () => {
    console.log("Deleted!");
    setOpen(false);        // close delete prompt
  ...
  return (
    <>
      ...
      {/* ✅ SUCCESS MODAL (ADDED ONLY) */}
      {showSuccess && (
        <CoordinatorAnnouncementDeleteConfirmation
