...
export default function AdminFeaturedAlumniDeletePromptandConfirmation({ children, featuredAlumniId, onSuccess }) {
  ...
  const confirmDelete = () => {
  if (!featuredAlumniId) return;

  router.delete(`/${import.meta.env.VITE_ADMIN_PORTAL_PREFIX}/featured-alumni/${featuredAlumniId}`, {
    onSuccess: () => {
      setSuccess(true);
