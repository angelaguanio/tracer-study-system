...
export default function CoordinatorFeaturedAlumniDeletePromptandConfirmation({ children, featuredAlumniId, onSuccess }) {
  ...
  const confirmDelete = () => {
    ...
    router.delete(`/coordinator/featured-alumni/${featuredAlumniId}`, {
      onSuccess: () => {
        setOpen(false); 
