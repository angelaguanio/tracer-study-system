...
export default function CoordinatorFeaturedAlumniCard({ featuredAlumni, onDeleteSuccess }) {
  const tableData = Array.isArray(featuredAlumni) ? featuredAlumni : featuredAlumni?.data ?? [];
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <button
          onClick={() => router.get(`/coordinator/featured-alumni/${row.original.id}`)}
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-2">
                    ...
                    <button
                      onClick={() =>
                        router.get(`/coordinator/featured-alumni/${item.id}`)
                      }
