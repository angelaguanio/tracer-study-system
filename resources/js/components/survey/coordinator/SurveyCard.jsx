...
export default function SurveyCard({ survey, isArchived = false }) {
    const handleDelete = () => {
        router.delete(route("admin.surveys.destroy", survey.id));
    };

    const handleArchive = () => {
        router.patch(route("admin.surveys.archive", survey.id));
    };

    const handleUnarchive = () => {
        router.patch(route("admin.surveys.unarchive", survey.id));
    };
                ...
                <div className="flex gap-2">
                    ...
                    {!isArchived && survey.has_responses && (
                        <Button
                            ...
                            onClick={() => router.get(route("admin.surveys.cect-analytics", survey.id))}
                        >
